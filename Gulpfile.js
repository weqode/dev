...
var project = 'WeQode-Framework', // Project name, used for build zip.
    url = 'http://localhost:8888/we-qode/', // Local Development URL for BrowserSync. Change as-needed.
...
gulp.task('build', function(cb) {
    runSequence('styles', 'cleanup', 'scriptsJs', 'buildFiles', 'buildImages', 'buildZip', 'cleanupFinal', cb);
});
